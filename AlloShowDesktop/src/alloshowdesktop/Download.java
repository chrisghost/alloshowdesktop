...
class Download extends Observable implements Runnable {
    ...
    public Download(URL url, String show, Integer season, Integer episode) {
        this.url = url;
        size = -1;
        downloaded = 0;
        status = DOWNLOADING;
    ...
    public void run() {
      ...
      /* Set the size for this download if it
         hasn't been already set. */
            ...
            file = new RandomAccessFile("/tmp/"+getFileName(url), "rw");
    ...
    public void setLastDownloaded(int lastDownloaded) {
